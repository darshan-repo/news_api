...
class TechCrunchNewsDetailsScreen extends StatefulWidget {
  final Article news;
  const TechCrunchNewsDetailsScreen({super.key, required this.news});

  @override
  State<TechCrunchNewsDetailsScreen> createState() => _TechCrunchNewsDetailsScreenState();
}

class _TechCrunchNewsDetailsScreenState extends State<TechCrunchNewsDetailsScreen> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text('TECH CRUNCH NEWS'),
